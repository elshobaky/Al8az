"""
settings for OpenAl8az project.
...
SECRET_KEY = 'hgkjhfjkshffhfuihjkvjkjk7834jhdfvbuiyr6jheru7ug337'
...
# blog defaults 
# edit defaults.json file with your own
import json
DEFAULTS = json.loads(open(MAIN_DIR+'/lib/defaults.json','r').read())
